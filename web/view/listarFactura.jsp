                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="Controlador?menu=Factura" method="POST" autocomplete="off">
                ...
                <tbody>
                    <c:forEach var="f" items="${factura}">
                        <tr>
                            ...
                            <td>${f.getHoraEmision()}</td>
                            <td>${f.getTotalFactura()}</td>
                            <td>${f.getIdSucursal()}</td>
                            ...
                            <td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-floating mb-3">
                                                        <input type="date" class="form-control" id="floatingInput" value="${f.getFechaEmision()}" name="txtFecha" required>
                                                        <label for="floatingInput">Fecha de Emisión</label>
                                                    </div>
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="floatingInput" value="${f.getHoraEmision()}" name="txtHora" required>
                                                        <label for="floatingInput">Hora de Emisión</label>
                                                    </div>
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="floatingInput" value="${f.getTotalFactura()}" name="txtTotalFactura" required>
                                                        <label for="floatingInput">Total</label>
                                                    </div>
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="floatingInput" value="${f.getIdSucursal()}" name="txtCodSucursal" required>
                                                        <label for="floatingInput">Código de Sucursal</label>
                                                    </div>
                                                    <div class="form-floating mb-3">
                                                        <input type="text" class="form-control" id="floatingInput" value="${f.getIdCliente()}" name="txtCodCliente" required>
                                                        <label for="floatingInput">Código de Cliente</label>
                                                    </div>
                                ...
                                <a class="btn btn-danger" href="Controlador?menu=Factura&accion=Eliminar&idFactura=${f.getIdFactura()}"><i class="fa-solid fa-trash" style="color: #ffffff;"></i></a>
                            </td>  
                        </tr>
                    </c:forEach>
                </tbody>
