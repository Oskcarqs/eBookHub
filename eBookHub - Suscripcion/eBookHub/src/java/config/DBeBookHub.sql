...
Create table Cliente (
    ...
    constraint FK_Cliente_TipoSuscripcion foreign key (idTipoSuscripcion)
...
Insert into Sucursal(nombreSucursal, direccionSucursal, telefonoSucursal) values('Edificio Luna', '8va Av. 9-96 z.21', '6452-1325');
Insert into Sucursal(nombreSucursal, direccionSucursal, telefonoSucursal) values('Edificio Sol', '9na Calle 5-52 z.11', '65845211');
Insert into Sucursal(nombreSucursal, direccionSucursal, telefonoSucursal) values('Edificio Pi', 'Condado Ricinos z.14', '1234-5678');
Insert into Sucursal(nombreSucursal, direccionSucursal, telefonoSucursal) values('Edificio Pablo Neruda', '8va Calle 9-63 Col. Jardines Oscuros z.13', '7410-2589');
Insert into Sucursal(nombreSucursal, direccionSucursal, telefonoSucursal) values('Edificio Miguel Angel Asturias', 'Avenida de los Álamos 8-90, Zona 16, Villa Nueva', '5274-8016');
...
Insert into TipoSuscripcion (nombreTipoSuscripcion, descripcionTipoSuscripcion, precioTipoSuscripcion) values ('Basico', 'Acceso a una selección económica de libros electrónicos.', '9.99');
Insert into TipoSuscripcion (nombreTipoSuscripcion, descripcionTipoSuscripcion, precioTipoSuscripcion) values ('Estandar', 'Amplia biblioteca de libros electrónicos con opciones adicionales.', '19.99');
Insert into TipoSuscripcion (nombreTipoSuscripcion, descripcionTipoSuscripcion, precioTipoSuscripcion) values ('Pro', 'Experiencia de lectura premium con acceso exclusivo y ventajas adicionales.', '29.99');
INSERT INTO Cliente (nombreCliente, apellidoCliente, fechaDeNacimientoCliente, direccionCliente, telefonoCliente, nickNameUsuario, emailUsuario, passwordUsuario)
VALUES ('Juan', 'Perez', '1990-05-15', '123 Calle Principal', '1234567890', 'juanjito123', 'juan@example.com', 'contraseña123');
INSERT INTO Cliente (nombreCliente, apellidoCliente, fechaDeNacimientoCliente, direccionCliente, telefonoCliente, nickNameUsuario, emailUsuario, passwordUsuario)
VALUES ('María', 'López', '1985-09-20', '456 Avenida Secundaria', '9876543210', 'marialo', 'maria@example.com', 'password456');
INSERT INTO Cliente (nombreCliente, apellidoCliente, fechaDeNacimientoCliente, direccionCliente, telefonoCliente, nickNameUsuario, emailUsuario, passwordUsuario)
VALUES ('Carlos', 'González', '1998-03-10', '789 Calle Terciaria', '5555555555', 'carlitos', 'carlos@example.com', 'securepass123');
INSERT INTO Cliente (nombreCliente, apellidoCliente, fechaDeNacimientoCliente, direccionCliente, telefonoCliente, nickNameUsuario, emailUsuario, passwordUsuario)
VALUES ('Laura', 'Martínez', '1992-07-25', '1010 Calle Cuarta', '7777777777', 'lauram', 'laura@example.com', 'mysecretword');
INSERT INTO Cliente (nombreCliente, apellidoCliente, fechaDeNacimientoCliente, direccionCliente, telefonoCliente, nickNameUsuario, emailUsuario, passwordUsuario)
VALUES ('Pedro', 'Ramírez', '1980-12-05', '222 Ruta Principal', '3333333333', 'pedroram', 'pedro@example.com', 'peterpass789');
