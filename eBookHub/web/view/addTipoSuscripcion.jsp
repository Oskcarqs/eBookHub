<%-- 
    Document   : add
    Created on : 5/07/2023, 09:22:36 AM
    Author     : informatica
--%>
...
<html>
    ...
    <body>
        ...
        <form action="ControladorTipoSuscripcion?accion=addTipoSuscripcion">
            ...
            <input type="text" name="txtDescr"><br><br>
            <strong>Precio tipo suscripcion:</strong><br>
            <input type="text" name="txtPrec"><br><br>
