                            ...
                            <c:forEach var="sucursal" items="${sucursal}">
                                <tr>                            
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger" href="Controlador?menu=Sucursal&accion=Eliminar&idSucursal=${sucursal.getIdSucursal()}"><i class="fa-solid fa-trash" style="color: #ffffff;"></i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
