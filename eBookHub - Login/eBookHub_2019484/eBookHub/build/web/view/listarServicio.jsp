                        ...
                        <div class="modal-content">
                            <form action="Controlador?menu=Servicio" method="POST" autocomplete="off">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="txtIdTipoServicio" required>
                                        <label for="floatingInput">ID TIPO SERVICIO</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="txtIdLibro" required>
                                        <label for="floatingInput">ID LIBRO</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="floatingInput" name="txtIdCliente" required>
