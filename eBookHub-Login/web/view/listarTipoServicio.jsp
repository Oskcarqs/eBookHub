                            ...
                            <c:forEach var="t" items="${tipoServicio}">
                                <tr>                            
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger" href="Controlador?menu=TipoServicio&accion=Eliminar&idTipoServicio=${t.getIdTipoServicio()}"><i class="fa-solid fa-trash" style="color: #ffffff;"></i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
