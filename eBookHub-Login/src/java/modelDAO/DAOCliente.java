...
public class DAOCliente {
    ...
    public Cliente validar(String usuario, String clave) {
        ...
        String sql = "select * from Cliente where emailUsuario = ? and passwordUsuario = ?";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                cliente.setPasswordUsuario(rs.getString("passwordUsuario"));
                cliente.setNickNameUsuario(rs.getString("nickNameUsuario"));
