        ...
        <div class="container-fluid mt-3">
            <div class="row gx-3">
                <div class="col-8">
                    <table class="table aling-middle table-striped text-center table-hover">
                        <thead class="table-dark">
                            <tr>
                                <td>Sucursal</td>
                                <td class="col-sm-5">Dirección</td>
                                <td>Teléfono</td>
                                <td>Acciones</td>
                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach var="sucursal" items="${sucursal}">
                                <tr>                            
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editarModal${sucursal.getIdSucursal()}">
                                            <i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i>
                                        </button>
                                        <div class="modal fade" id="editarModal${sucursal.getIdSucursal()}" tabindex="-1" aria-labelledby="editarModalLabel${sucursal.getIdSucursal()}" aria-hidden="true">
                                            <form action="Controlador?menu=Sucursal&codigoSucursal=${sucursal.getIdSucursal()}" method="POST" autocomplete="off" >
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-floating my-3">
                                                                <input type="text" class="form-control form-control-sm" id="floatingInput" name="txtNombreSucursal" value="${sucursal.getNombreSucursal()}" required>
                                                                <label for="floatingInput">Sucursal</label>
                                                            </div>
                                                            <div class="form-floating my-3">
                                                                <textarea class="form-control" name="txtDireccionSucursal" id="floatingTextarea" style="height: 150px" required="on">${sucursal.getDireccionSucursal()}</textarea>
                                                                <label for="floatingTextarea">Dirección</label>
                                                            </div>
                                                            <div class="form-floating my-3">
                                                                <input type="text" class="form-control form-control-sm" id="floatingInput" name="txtTelefonoSucursal" value="${sucursal.getTelefonoSucursal()}" required>
                                                                <label for="floatingTextarea">Teléfono</label>
                                                            </div>                                                                
                                                        </div>
                                        ...
                                        <a class="btn btn-danger btn-sm" href="Controlador?menu=Sucursal&accion=Eliminar&idSucursal=${sucursal.getIdSucursal()}"><i class="fa-solid fa-trash" style="color: #ffffff;"></i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                ...
                <div class="col-4">
                    ...
                    <form action="Controlador?menu=Sucursal" method="POST" autocomplete="off">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-floating my-3">
                                    <input type="text" class="form-control form-control-sm" id="floatingInput" name="txtNombreSucursal" required>
                                    <label for="floatingInput">Sucursal</label>
                                </div>
                                <div class="form-floating my-3">
                                    <textarea class="form-control" name="txtDireccionSucursal" id="floatingTextarea" style="height: 150px" required="on"></textarea>
                                    <label for="floatingTextarea">Dirección</label>
                                </div>
                                <div class="form-floating my-3">
                                    <input type="text" class="form-control form-control-sm" id="floatingInput" name="txtTelefonoSucursal" required>
