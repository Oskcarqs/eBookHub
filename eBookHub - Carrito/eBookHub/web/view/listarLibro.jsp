        ...
        <div class="container-fluid p-4">
            ...
            <table class="table aling-middle table-striped text-center table-hover mt-3">
                <thead class="table-dark">
                    <tr>
                        <td>Titulo Libro</td>
                        <td class="col-sm-4">Descripción Libro</td>
                        <td>Publicación</td>
                        <td>Idioma</td>
                        <td>Precio</td>
                        <td>Tipo</td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-floating">
                                                        <textarea class="form-control" id="floatingTextarea2" style="height: 100px" name="txtDescripcionLibro" required="on">${libros.getDescripcionLibro()}</textarea>
                                                        <label for="floatingTextarea2">Descripción Libro</label>
                                                    </div>
                                                    <div class="form-floating mb-3">
