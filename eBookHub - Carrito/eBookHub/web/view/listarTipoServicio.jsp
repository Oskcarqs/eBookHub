        ...
        <div class="container-fluid mt-3">
            <div class="row gx-3">
                <div class="col-8">
                    <table class="table aling-middle table-striped text-center table-hover">
                        <thead class="table-dark">
                            <tr>
                                <td class="col-sm-5">Nombre del Tipo Servicio</td>
                                <td>Acciones</td>
                            </tr>
                        </thead>
                        <tbody>
                            <c:forEach var="t" items="${tipoServicio}">
                                <tr>                            
                                    <td>${t.getNombreTipoServicio()}</td>
                                    <td>
                                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editarModal${t.getIdTipoServicio()}">
                                            <i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i>
                                        </button>
                                        <div class="modal fade" id="editarModal${t.getIdTipoServicio()}" tabindex="-1" aria-labelledby="editarModalLabel${t.getIdTipoServicio()}" aria-hidden="true">
                                            <form action="Controlador?menu=TipoServicio&codigoTipoServicio=${t.getIdTipoServicio()}" method="POST" autocomplete="off" >
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <!-- Titulo -->
                                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Editar Tipo Servicio</h1>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-floating my-3">
                                                                <input type="text" class="form-control form-control-sm" id="floatingInput" name="txtNombreTipoServicio" value="${t.getNombreTipoServicio()}" required>
                                                                <label for="floatingInput">Nombre del Tipo Servicio</label>
                                                            </div>
                                                        </div>
                                        ...
                                        <a class="btn btn-danger btn-sm" href="Controlador?menu=TipoServicio&accion=Eliminar&idTipoServicio=${t.getIdTipoServicio()}"><i class="fa-solid fa-trash" style="color: #ffffff;"></i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                ...
                <div class="col-4">
                    ...
                    <form action="Controlador?menu=TipoServicio" method="POST" autocomplete="off">
                        <div class="card">
                            <div class="card-header text-center">
                                <h5>Agregar Tipo Servicio</h5>
                            </div>
                            <div class="card-body">
                                <div class="form-floating my-3">
                                    <input type="text" class="form-control form-control-sm" id="floatingInput" name="txtNombreTipoServicio" required>
                                    <label for="floatingInput">Nombre Tipo Servicio</label>
                                </div>
