                                            ...
                                            <div class="col-9 ">
                                                <div class="px-5">
                                                    ...
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <a class="btn btn-dark shadow"  href="ControladorCarrito?menu=Carrito&accion=AgregarCarrito&idLibro=${l.getIdLibro()}"><i class="fa-solid fa-truck" style="color: #ffffff;"></i> Agregar al carrito</a>
