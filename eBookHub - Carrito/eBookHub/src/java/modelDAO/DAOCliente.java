    ...
    public Cliente buscarCliente(int id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                cl.setFechaDeNacimientoCliente(rs.getString("fechaDeNacimientoCliente"));
                cl.setDireccionCliente(rs.getString("direccionCliente"));
                cl.setTelefonoCliente(rs.getString("telefonoCliente"));
                cl.setNickNameUsuario(rs.getString("nickNameUsuario"));
                cl.setEmailUsuario(rs.getString("emailUsuario"));
                cl.setPasswordUsuario(rs.getString("passwordUsuario"));
                cl.setImgCLiente(rs.getBinaryStream("imgCLiente"));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
