...
public class LibroDAO {
    ...
    public int actualizarstock(int id, double sac){
        String sql ="update libro set stockLibro=? where idLibro=?";
        try {
            con = connect.getConnection();
            ps = con.prepareStatement(sql);
            ps.setDouble(1, sac);
    ...
    public Libro buscarlib(int id) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                libro.setFotoLibro(rs.getBinaryStream(2));
                libro.setTituloLibro(rs.getString(3));
                libro.setDescripcionLibro(rs.getString(4));
                libro.setFechaDePublicacion(rs.getString(5));
                libro.setIdiomaLibro(rs.getString(6));
                libro.setCostoLibro(rs.getDouble(7));
                libro.setTipoLibro(rs.getString(8));
                libro.setStockLibro(rs.getInt(9));
                libro.setIdAutor(rs.getInt(10));
                libro.setIdEditorial(rs.getInt(11));
                libro.setIdCategoria(rs.getInt(12));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public Libro listLibro(int id) {
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                lib.setIdLibro(rs.getInt(1));
                lib.setTituloLibro(rs.getString(3));
                lib.setDescripcionLibro(rs.getString(4));
                lib.setFechaDePublicacion(rs.getString(5));
                lib.setIdiomaLibro(rs.getString(6));
                lib.setCostoLibro(rs.getDouble(7));
                lib.setTipoLibro(rs.getString(8));
                lib.setStockLibro(rs.getInt(9));
                lib.setIdAutor(rs.getInt(10));
                lib.setIdEditorial(rs.getInt(11));
                lib.setIdCategoria(rs.getInt(12));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
